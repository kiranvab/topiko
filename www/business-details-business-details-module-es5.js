  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["business-details-business-details-module"], {
    ...
    "RAKf": function RAKf(module, __webpack_exports__, __webpack_require__) {
      ...
      var BusinessDetailsPage = /*#__PURE__*/function () {
        function BusinessDetailsPage(actionsheetCtrl, router, route, storage, http, alertController) {
                      ...
                      return this.actionsheetCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this2.storage.set('bid', _this2.buid);

                            _this2.router.navigate(['/edit-business']);
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this4.http.get(_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"].ApiUrl + "deletebranch.php?brid=" + _this4.branches[i].id).subscribe(function (data) {
                              console.log("Response", data); //this.Branches();
