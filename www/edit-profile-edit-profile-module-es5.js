  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["edit-profile-edit-profile-module"], {
    ...
    "x9OG": function x9OG(module, __webpack_exports__, __webpack_require__) {
      ...
      var EditProfilePage = /*#__PURE__*/function () {
        // designation: any;
        function EditProfilePage(storage, camera, http, router) {
        ...
        _createClass(EditProfilePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.storage.get("uid").then(function (val) {
              ...
              _this.http.get(_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"].ApiUrl + "profile.php?user_id=" + _this.uid).subscribe(function (data) {
                _this.profile = data;
                _this.uid = _this.profile[0].id;
                _this.name = _this.profile[0].name;
                _this.mobile = _this.profile[0].mobile;
                _this.email = _this.profile[0].email;
