        ...
        _createClass(MycardPage, [{
          ...
          value: function loadcard() {
            ...
            this.http.get(_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"].ApiUrl + "getcarddetails.php?user_id=" + this.uid).subscribe(function (data) {
              ...
              console.log("Mycard Data", _this2.carddata);

              if (_this2.carddata == null) {
                _this2.router.navigate(['/createdvc']);
              } else {
                _this2.carddata = data;
                console.log(_this2.ucarddata);
              }
            });
          }
        }, {
          ...
          value: function morecards() {
            ...
            this.http.get(_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"].ApiUrl + "getcarddetails.php?user_id=" + this.uid).subscribe(function (data) {
              console.log(data);
              _this3.carddata = data; //this.router.navigate(['morevcards']);
            });
          }
        }]);
