      ...
      var AppComponent = AppComponent_1 = /*#__PURE__*/function () {
        function AppComponent(storage, events, http, route, platform, alertController, statusBar, screenOrientation) {
          ...
          this.appPages = [{
            title: 'Home',
            url: '/home',
            img: 'assets/menu/home.svg'
          }, {
            title: 'Business',
            url: '/my-business',
            img: 'assets/menu/business.svg'
          }, {
            title: 'Career',
            url: '/careerview',
            img: 'assets/menu/careers.svg'
          }, {
            title: 'Wallet',
            url: '/wallet',
            img: 'assets/menu/wallet.svg'
          }, {
            title: 'My Visting Card',
            url: '/mycard',
            img: 'assets/menu/visitingcard.svg'
          }, {
            title: 'Qr Reach',
            url: '/qrreach',
            img: 'assets/menu/qr-code.svg'
          }, // { title: 'Invitation', url: '/folder/Inbox', icon: 'mail-open' },
          //{ title: 'Referal', url: '/folder/Inbox', img: 'assets/menu/invitation.svg' },
          {
            title: 'Reach Us',
            url: '/contact',
            img: 'assets/menu/reach.svg'
          }, {
            title: 'Logout',
            url: '/relogin',
            img: 'assets/menu/logout.svg'
          }];
            ...
            this.storage.get("userdetails").then(function (uval) {
              ...
              if (_this4.user_mobile) {
                _this4.http.get(AppComponent_1.ApiUrl + "checkincomming.php?user_mobile=" + _this4.user_mobile).subscribe(function (incoming) {
                  ...
                  _this4.call_type = _this4.incomming[0].call_type;
                  console.log("incoming:", _this4.incomming);

                  if (_this4.incomming != 0) {
                    if (_this4.call_type == 'audio') {
    ...
    "vY5A": function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          ...
          "mycard-mycard-module").then(__webpack_require__.bind(null,
        ...
        loadChildren: function loadChildren() {
          ...
          "edit-employee-edit-employee-module").then(__webpack_require__.bind(null,
