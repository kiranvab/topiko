...
let FavouritesPage = class FavouritesPage {
    constructor(actionsheetCtrl, route, storage, http) {
        ...
        this.storage.get("userdetails").then(val => {
            ...
            this.http.get(_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"].ApiUrl + "myfavorites.php?user_id=" + this.user_id).subscribe(response => {
                this.myfav = response;
                console.log('Myfavourite shops', this.myfav);
            });
            this.http.get(_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"].ApiUrl + "myfavproducts.php?user_id=" + this.user_id).subscribe(response => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ion-header ion-icon {\n  color: #ffffff;\n  font-size: 21px;\n}\n\nion-title {\n  font-size: 16px;\n  color: #ffffff;\n  padding: 0px;\n  padding-top: 1px;\n  letter-spacing: 0.6px;\n  text-align: left;\n}\n\nion-content {\n  --padding-top: 10px;\n  --padding-bottom: 65px;\n  --padding-start: 18px;\n  --padding-end: 18px;\n}\n\nion-card {\n  margin: 8px 0px;\n  padding: 10px;\n  box-shadow: 0px 3px 6px #00000029;\n}\n\n.avatar ion-avatar {\n  width: 61px;\n  height: 61px;\n}\n\n.border {\n  border: 0.2px solid #707070;\n}\n\n.user-name {\n  color: #22272a;\n  font-size: 18px;\n  margin: 0px;\n}\n\n.user-name ion-icon {\n  color: #39ac00;\n}\n\n.star {\n  margin-top: 5px;\n}\n\n.star ion-icon {\n  color: #fcb900;\n}\n\n.star span p {\n  font-size: 8px;\n  padding-left: 5px;\n  color: #22272a;\n}\n\n.time {\n  color: #9f9f9f;\n  font-size: 12px;\n  margin: 0px;\n  padding-top: 4px;\n}\n\np {\n  margin: 0%;\n  line-height: 18px;\n}\n\n.ellipsis ion-icon {\n  font-size: 18px;\n}\n\n.date {\n  text-align: right;\n  color: #9f9f9f !important;\n  font-size: 12px !important;\n  width: 100%;\n  margin-right: 7px;\n}\n\n.dat {\n  height: 0px;\n}\n\n.dat p {\n  position: relative;\n  bottom: 16px;\n}\n\nion-segment {\n  background: #f5f5f5;\n  color: #707070;\n  font-size: 0.9375em;\n}\n\nion-segment ion-label {\n  text-transform: capitalize;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
