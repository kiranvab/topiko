        ...
        _createClass(OffersPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.storage.get("bid").then(function (val) {
              ...
              _this.http.get(_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"].ApiUrl + "getbusinessoffers.php?bid=" + _this.buid).subscribe(function (data) {
                _this.offers = data;
                      ...
                      return this.actionsheetCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this2.storage.set("oid", _this2.offers[i].id);

                            _this2.route.navigate(['/edit-offer']);
                          }
                        }, {
                          text: 'Delete',
                          handler: function handler() {
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            console.log(_this3.offers[i].id);

                            _this3.http.get(_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"].ApiUrl + "deleteoffer.php?oid=" + _this3.offers[i].id).subscribe(function (data) {
