                      ...
                      return this.actionsheetCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this2.services[i].id;
                            console.log(_this2.services[i].id);

                            _this2.storage.set("sid", _this2.services[i].id);

                            _this2.router.navigate(['/edit-service']);
                          }
                        }, {
                          text: 'Delete',
                          handler: function handler() {
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this3.http.get(_app_component__WEBPACK_IMPORTED_MODULE_8__["AppComponent"].ApiUrl + "deleteservice.php?sid=" + _this3.services[i].id).subscribe(function (data) {
