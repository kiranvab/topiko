(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["records-records-module"], {
    /***/
    "+WUZ": function WUZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecordsPage", function () {
        return RecordsPage;
      });
      /* harmony import */
      ...
      var _raw_loader_records_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./records.page.html */
      "eCkT");
      /* harmony import */


      var _records_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./records.page.scss */
      "qA+B");
      /* harmony import */
      ...
      var RecordsPage = /*#__PURE__*/function () {
        function RecordsPage(http, route, router) {
        ...
        _createClass(RecordsPage, [{
          ...
          value: function playrec() {
            var base64Sound = '...'; // from plugin

            var audioRef = new Audio("data:audio/aac;base64,".concat(base64Sound));
      ...
      RecordsPage.ctorParameters = function () {
        return [{
      ...
      RecordsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    "1V/X": function VX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecordsPageModule", function () {
      ...
      var _records_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./records-routing.module */
      "Wklb");
      /* harmony import */


      var _records_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./records.page */
      "+WUZ");

      var RecordsPageModule = function RecordsPageModule() {
        _classCallCheck(this, RecordsPageModule);
      };

      RecordsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _records_routing_module__WEBPACK_IMPORTED_MODULE_5__["RecordsPageRoutingModule"]],
    ...
    /***/
    "Wklb": function Wklb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecordsPageRoutingModule", function () {
      ...
      var _records_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./records.page */
      "+WUZ");
      ...
      var RecordsPageRoutingModule = function RecordsPageRoutingModule() {
        _classCallCheck(this, RecordsPageRoutingModule);
      };

      RecordsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    "eCkT": function eCkT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "qA+B": function qAB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "ion-header ion-icon {\n  color: #ffffff;\n  font-size: 21px;\n}\n\nion-title {\n  font-size: 16px;\n  color: #ffffff;\n  padding: 0px;\n  padding-top: 1px;\n  letter-spacing: 0.6px;\n  text-align: left;\n}\n\nion-content {\n  --padding-bottom: 80px;\n  --padding-start: 18px;\n  --padding-end: 18px;\n}\n\nion-card {\n  margin: 0.75em 0px;\n  padding: 7px;\n  box-shadow: 0px 3px 6px #00000029;\n}\n\n.avatar ion-avatar {\n  width: 61px;\n  height: 61px;\n}\n\n.border {\n  border: 0.2px solid #707070;\n}\n\n.user-name {\n  color: #22272a;\n  font-size: 18px;\n  margin: 0px;\n}\n\n.user-name ion-icon {\n  color: #39ac00;\n}\n\n.star {\n  margin-top: 5px;\n}\n\n.star ion-icon {\n  color: #fcb900;\n}\n\n.star span p {\n  font-size: 0.5em;\n  padding-left: 5px;\n  color: #22272a;\n}\n\n.time {\n  color: #9f9f9f;\n  font-size: 12px;\n  margin: 0px;\n}\n\np {\n  margin: 0%;\n  line-height: 18px;\n}\n\n.ellipsis ion-icon {\n  font-size: 18px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    }
  }]);
})();
