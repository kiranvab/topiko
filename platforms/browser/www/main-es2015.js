...
module.exports = __webpack_require__(/*! /Users/apple/Desktop/Topiko/src/main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'calls',
        loadChildren: () => Promise.all(/*! import() | calls-calls-module */[__webpack_require__.e("default~calls-calls-module~calls-contact-calls-contact-module~connect-connect-module"), __webpack_require__.e("calls-calls-module")]).then(__webpack_require__.bind(null, /*! ./calls/calls.module */ "Ugfu")).then(m => m.CallsPageModule)
    },
    {
        path: 'connect',
        loadChildren: () => Promise.all(/*! import() | connect-connect-module */[__webpack_require__.e("default~calls-calls-module~calls-contact-calls-contact-module~connect-connect-module"), __webpack_require__.e("connect-connect-module")]).then(__webpack_require__.bind(null, /*! ./connect/connect.module */ "yXIz")).then(m => m.ConnectPageModule)
    },
    {
        path: 'dial',
    ...
    {
        path: 'calls-contact',
        loadChildren: () => Promise.all(/*! import() | calls-contact-calls-contact-module */[__webpack_require__.e("default~calls-calls-module~calls-contact-calls-contact-module~connect-connect-module"), __webpack_require__.e("calls-contact-calls-contact-module")]).then(__webpack_require__.bind(null, /*! ./calls-contact/calls-contact.module */ "Aw3t")).then(m => m.CallsContactPageModule)
    },
    {
        path: 'chats-contact',
    ...
    {
        path: 'videocall',
        loadChildren: () => __webpack_require__.e(/*! import() | videocall-videocall-module */ "videocall-videocall-module").then(__webpack_require__.bind(null, /*! ./videocall/videocall.module */ "6Ylz")).then(m => m.VideocallPageModule)
    },
    {
        path: 'businesses',
