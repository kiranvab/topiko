(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~calls-calls-module~calls-contact-calls-contact-module~connect-connect-module"], {
    /***/
    "Pj7w": function Pj7w(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AudiowebrtcService", function () {
      ...
      var AudiowebrtcService = /*#__PURE__*/function () {
        function AudiowebrtcService() {
          _classCallCheck(this, AudiowebrtcService);
        ...
        _createClass(AudiowebrtcService, [{
          key: "getMedia",
          ...
          value: function call(partnerId) {
            ...
            call.on('stream', function (stream) {
              console.log(stream);
              _this3.partnerEl.srcObject = stream;
            });
          }
        }, {
          key: "wait",
          value: function wait() {
            ...
            this.peer.on('call', function (call) {
              call.answer(_this4.myStream);
              call.on('stream', function (stream) {
                _this4.partnerEl.srcObject = stream;
              });
            });
          }
        }, {
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      alert("Audio Devices " + audioDevices[1].deviceId);
                      _context3.next = 8;
                      return paudio.setSinkId(audioDevices[1].deviceId);

                    case 8:
                      alert('partner Audio is being played on ' + paudio.sinkId);
      ...
      AudiowebrtcService.ctorParameters = function () {
        return [];
      };

      AudiowebrtcService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AudiowebrtcService);
      /***/
    },
    ...
    /***/
    "U+ex": function UEx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AudioToggle", function () {
        return AudioToggle;
      });
      /* harmony import */
      ...
      var AudioToggle = Object(_capacitor_core__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"])('AudioToggle', {
        web: function web() {
          return __webpack_require__.e(
          /*! import() | web */
          "web").then(__webpack_require__.bind(null,
          /*! ./web */
          "AejP")).then(function (m) {
            return new m.AudioToggleWeb({
              name: name
            });
          });
        }
    ...
    /***/
    "XhEF": function XhEF(module, exports) {
    ...
    /***/
    "fOwQ": function fOwQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    "oLy0": function oLy0(module, exports, __webpack_require__) {
      var require;
...
//# sourceMappingURL=default~calls-calls-module~calls-contact-calls-contact-module~connect-connect-module-es5.js.map